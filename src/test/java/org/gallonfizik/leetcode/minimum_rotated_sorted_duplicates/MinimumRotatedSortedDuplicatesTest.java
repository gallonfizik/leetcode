...
import org.gallonfizik.leetcode.minimum_rotated_sorted_duplicates.MinimumRotatedSortedDuplicates;
import org.junit.jupiter.api.Test;
import org.junit.jupiter.params.ParameterizedTest;
import org.junit.jupiter.params.provider.Arguments;
import org.junit.jupiter.params.provider.MethodSource;

class MinimumRotatedSortedDuplicatesTest {
    static Stream<Arguments> source() {
        return Stream.of(
                Arguments.of(new int[]{1, 1}, 1),
                Arguments.of(new int[]{6, 7, 8, 1, 2, 3, 4, 5}, 1),
                Arguments.of(new int[]{10, 1, 10, 10, 10}, 1),
                Arguments.of(new int[]{10, 10, 1, 10, 10}, 1),
                Arguments.of(new int[]{10, 10, 1, 2, 3}, 1),
                Arguments.of(new int[]{10, 10, 1, 2, 2, 3}, 1),
                Arguments.of(new int[]{4, 5, 1, 2, 3}, 1),
                Arguments.of(new int[]{2}, 2),
                Arguments.of(new int[]{3, 1, 2}, 1),
                Arguments.of(new int[]{3, 1, 3}, 1),
    ...
    void acceptance(int[] nums, int expected) {
        int result = new MinimumRotatedSortedDuplicates().findMin(nums);
    ...
    void benchmark() {
        ...
        MinimumRotatedSortedDuplicates instance = new MinimumRotatedSortedDuplicates();
